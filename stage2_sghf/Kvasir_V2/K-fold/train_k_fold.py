...
from stage2_sghf.Kvasir_V2.custom_dataset import MedicalImageDataset,read_split_data

from torch.optim.lr_scheduler import StepLR
from stage2_sghf.Kvasir_V2.train_kvasir import initialize_weights,ASLSingleLabel
from sklearn.model_selection import StratifiedKFold


def build_one_fold_loaders(all_paths, all_labels, train_idx, val_idx,
                           transform_train, transform_valid,
                           batch_size_train=16, batch_size_val=16, num_workers=8):
...
def main_kfold():
    ...
    all_paths, all_labels, class_indices = read_all_data(data_path)
